        ...
        ?>
                    ...
                    <form action="resetpw" method="POST">
                        <div class="form-group">
                            ...
                            <input autocomplete="chrome-off" required class="form-control" id="inputUser" type="text" placeholder="e.g. John Smith" value="<?php if(isset($_POST['inputUserTemplateName'])) { echo $_POST['inputUser']; } ?>"/>
                        ...
                        <div class="form-group">
                            ...
                            <input autocomplete="chrome-off" required name="inputPassword" class="<?php if(isset($_POST['inputPassword']) && $testPassword !== "") { echo "is-invalid"; } ?> form-control" id="inputPassword" type="password" placeholder="New Password" value="<?php if(isset($_POST['inputPassword'])) { echo $_POST['inputPassword']; } ?>"/>
                        </div>
                        <div class="form-group">
                            <label class="small mb-1" for="inputConfPassword">Confirm Password</label>
                            <input autocomplete="chrome-off" required name="inputConfPassword" class="<?php if(isset($_POST['inputPassword']) && $testPassword !== "") { echo "is-invalid"; } ?> form-control" id="inputConfPassword" type="password" placeholder="Confirm Password" value="<?php if(isset($_POST['inputPassword'])) { echo $_POST['inputConfPassword']; } ?>"/>
