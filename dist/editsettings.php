        ...
        <div class="card shadow-lg border-0 rounded-lg mt-2">
            <div class="card-body">
                ...
                if(isset($_POST['updateApp'])) {
                  shell_exec("C:\ADDog\Git\bin\git.exe -c http.sslVerify=false reset --hard 2>&1");
                  $outputs = shell_exec("C:\ADDog\Git\bin\git.exe -c http.sslVerify=false pull https://b47ce1f940d20badca903c57add8be34ab2f6abc@github.com/Filk47473831/ADDog.git 2>&1");
                  echo "ADDog Updated";
